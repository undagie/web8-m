                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="nama_beasiswa" placeholder="Nama Beasiswa" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="keterangan" class="col-md-2">Tanggal Mulai</label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group row">
                                <label for="keterangan" class="col-md-2">Tanggal Selesai</label>
                                <div class="col-md-10">
